...
SimpsonComboBoxItem::SimpsonComboBoxItem(QGridLayout *inputLayout, QGridLayout *outputLayout, std::shared_ptr<BarChart> chart):
	AbstractComboBoxItem(inputLayout, outputLayout, chart)
{
}

void SimpsonComboBoxItem::itemChoosed()
{
	clear();
...
void SimpsonComboBoxItem::showStatistic(int sampleSize)
{
